...
$query = "SELECT nama, nomakaun, nomtel, nilai, nama_ngo FROM sumbangan";
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" style=" background-color:pink">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="cchart.php">
              <i class="ti-star menu-icon"></i>
              <span class="menu-title"style=" color:black;font-family:verdana">report test</span>
            </a>
          </li>
      ...
      <div class="main-panel" style="background-color: aliceblue;">
        <div class="content-wrapper" style="background-color:white ;">
          ...
          <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4 style=" color:black;font-family:verdana">Senarai sumbangan</h4>
...
<div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->  
    <table class="table table-bordered table-hover table-striped " style="table-layout: relative; " >  
        ...
        <th ><a href="<?php echo sortorder('nama'); ?>" class="sort">nama</a></th>
            <th ><a href="<?php echo sortorder('nomakaun'); ?>" class="sort">nomakaun</a></th> 
            <th ><a href="<?php echo sortorder('nomtel'); ?>" class="sort">nombor telefon</a></th>
            <th ><a href="<?php echo sortorder('nama_ngo'); ?>" class="sort">nama ngo</a></th>
            <th ><a href="<?php echo sortorder('nilai'); ?>" class="sort">nilai (RM)</a></th>
        ...
        $sql = "SELECT COUNT(*) AS cntrows FROM sumbangan";
        $result = mysqli_query($conn,$sql);
        $fetchresult = mysqli_fetch_array($result);
        $allcount = $fetchresult['cntrows'];

        $orderby = " ORDER BY users_id desc ";
        if(isset($_GET['order_by']) && isset($_GET['sort'])){
            $orderby = ' order by '.$_GET['order_by'].' '.$_GET['sort'];
        }

        $sql = "SELECT * FROM sumbangan ".$orderby." limit $row,".$rowperpage;
        $result = mysqli_query($conn,$sql);
        $sno = $row + 1;
...
<!--here showing results in the table -->  
            ...
            <td><?php echo $nama_ngo;  ?></td> 
            <td><?php echo 'RM ',$nilai;  ?></td> 
